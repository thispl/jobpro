...
class Closure(Document):
    ...
    def before_save(self):
        ...
        self.custom_modified_status = previous.status if previous else None
    def validate(self):
        ...
        if self.payment=="Client" and self.candidate_payment_company_currenc and self.candidate_payment_company_currenc>0:
            self.candidate_payment_company_currenc=0
            self.candidate_si=0
        if self.payment=="Candidate" and self.client_payment_company_currency and self.client_payment_company_currency>0:
            self.client_payment_company_currency=0
            self.client_si=0
