      ...
      <div class="bg-white mt-0 shadow-lg shadow-gray-600">
        ...
        <div class="mx-10 flex md:justify-end items-center mr-[50px] md:p-6">
          ...
          <div class="hidden md:block flex mr-24 md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse register">
            <p class="text-[#05264e] font-medium tracking-wide ml-[-180px] reg-class">Not Registered ? <router-link to="registration" class="font-semibold" style="color: #05264e;">Register</router-link> here</p>
          </div>
        ...
        <!-- Mobile -->
          <div class="md:hidden mx-10 flex md:justify-end items-center relative">
              ...
              <!-- <img class="w-[140px] ml-[-30px] logo-depth" src="./assets/Inter/teampro.png" alt="Teampro Logo" /> -->
                <p class="text-[#05264e] font-medium text-sm ml-auto">Not Registered ? <router-link to="registration" class="font-semibold" style="color: #05264e;">Register</router-link> here</p>
          </div>
      </div>
    </template>
    ...
    .logo-depth  {
      filter: drop-shadow(0px 0.8px 0.1px white);
    }
