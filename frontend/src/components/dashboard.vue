<template>
    ...
    <!-- Shimmer -->
    <div v-if="topSection" class="grid grid-cols-1 md:grid-cols-5 gap-5 mt-5 mx-5 md:mx-10 justify-center  font-sans">
        <div v-for="i in 5" :key="i" class="bg-white shadow-lg shadow-gray-600 rounded-lg px-6 py-4 w-full flex">
    ...
    <!-- <transition> -->
    <div v-if="!topSection" class="grid grid-cols-1 md:grid-cols-5 gap-5 mt-5 mx-5 md:mx-10 justify-center  font-sans">
        <div class="bg-white shadow-lg shadow-gray-600 rounded-lg px-6 py-4 w-full flex">
            ...
            <div class="pl-4">
                <p class="text-[#777b76] font-semibold text-xs">Earnables</p>
                <h1 class="text-[#05264e] text-md md:text-xl font-bold mt-2">₹{{ totalEarnables }}/-</h1>
            </div>
        </div>
        <div class="bg-white shadow-lg shadow-gray-600 rounded-lg px-6 py-4 w-full flex">
            <div class="flex items-center bg-[whitesmoke] rounded-full px-2.5 py-2.5">
            ...
            <div class="pl-4">
                ...
                <h1 class="text-[#05264e] text-md md:text-xl font-bold mt-2">{{ referrals }}</h1>
            </div>
        </div>
        <div class="bg-white shadow-lg shadow-gray-600 rounded-lg px-6 py-4 w-full flex">
            <div class="flex items-center bg-[whitesmoke] rounded-full px-2.5 py-2.5">
            ...
            <div class="pl-4">
                ...
                <h1 class="text-[#05264e] text-md md:text-xl font-bold mt-2">{{ points }}</h1>
            </div>
        </div>
        <div class="bg-white shadow-lg shadow-gray-600 rounded-lg px-6 py-4 w-full flex">
            <div class="flex items-center bg-[whitesmoke] rounded-full px-2.5 py-2.5">
            ...
            <div class="pl-4">
                ...
                <h1 class="text-[#05264e] text-md md:text-xl font-bold mt-2">₹{{ received }}/-</h1>
            </div>
        </div>
        <div class="bg-white shadow-lg shadow-gray-600 rounded-lg px-6 py-4 w-full flex">
            <div class="flex items-center bg-[whitesmoke] rounded-full px-2.5 py-2.5">
            ...
            <div class="pl-4">
                ...
                <h1 class="ml-auto text-[#05264e] text-md md:text-xl font-bold mt-2">₹{{ outstanding }}/-</h1>
            </div>
        </div>
    </div>
    <!-- </transition> -->
    ...
    <div v-if="middleSection" class="flex justify-center">
        <div class="mt-10 grid grid-cols-12 gap-2 md:gap-8 w-full m-5 md:m-10 ">
            <div class="col-span-8 bg-white shadow-lg shadow-gray-600 rounded-xl p-6 pb-14 hidden md:block">
                <div class="flex">
            ...
            <div to="/referpro/refer-candidate" class="col-span-12  md:col-span-4 bg-white shadow-lg shadow-gray-600 rounded-xl p-6">
            ...
            <!-- <mobile-section> -->
            <div class="col-span-12 mt-5  bg-white shadow-lg shadow-gray-600 rounded-xl p-6 pb-14 md:hidden">
                <div class="flex ">
                    <div class="bg-gray-300 rounded-md h-6 w-[62%] mb-4 animate-pulse"></div>
                    <div class="bg-gray-300 mt-[-5px] ml-auto w-[30%] rounded-lg h-8 w-16 animate-pulse"></div>
                </div>

                <div class="flex flex-col mr-1 text-center w-full justify-center gap-5 mt-6">
                    <div v-for="i in 4" :key="i" class="w-[100%] ">
                        <div class="flex  items-center  ">
                            <div class="flex  justify-center mt-3  ">
                                <div class="bg-gray-300 rounded-full h-14 w-14 animate-pulse"></div>
                            </div>
                            <div class=" ml-3 flex flex-col  w-full">
                                <!-- <div class="flex justify-center mt-3 border border-yellow-500"> -->
                                    <div class="bg-gray-300 rounded-md h-5 w-[90%] mt-2 animate-pulse"></div>
                                <!-- </div> -->
                                <!-- <div class="flex justify-center mt-1 border border-blue-500"> -->
                                    <div class="bg-gray-300 rounded-md h-5 w-[90%] mt-2 animate-pulse"></div>
                                <!-- </div> -->
                            </div>
                        </div>
    ...
    <div v-if="!middleSection" class="  flex justify-center">
        <div class="mt-10 grid grid-cols-12 gap-2 md:gap-8 w-full m-5 md:m-10 ">
            ...
            <router-link to="/referpro/refer-candidate" class="  col-span-12  md:col-span-4 bg-white shadow-lg shadow-gray-600 rounded-xl p-6">
            ...
            <div class="col-span-12 mt-5  bg-white shadow-lg shadow-gray-600 rounded-xl p-6 pb-14 md:hidden">
                <div class="flex">
                    <h1 class="text-[#05264e] font-semibold text-md mb-5 capitalize">Help your friends get a job and get rewarded</h1>
                    <div class="ml-auto w-[350px] mt-[-4px]">
                        <img src="https://i.postimg.cc/3JyRDgdL/Artboard-2.png" width="250px" />
                    </div>
                </div>
                ...
                <div class="flex flex-col mr-1 text-center w-full justify-center gap-5 mt-6">
                    <div class="w-[100%] ">
                        <div class ="flex items-center ">
                        <div class="flex  justify-center mt-3 ">
                            <svg class="h-14 w-14 rounded-full pl-1 py-5 bg-white shadow-lg shadow-gray-600" xmlns="http://www.w3.org/2000/svg" fill="#0070cc" viewBox="0 20 576 512">
                                <path d="M352 224l-46.5 0c-45 0-81.5 36.5-81.5 81.5c0 22.3 10.3 34.3 19.2 40.5c6.8 4.7 12.8 12 12.8 20.3c0 9.8-8 17.8-17.8 17.8l-2.5 0c-2.4 0-4.8-.4-7.1-1.4C210.8 374.8 128 333.4 128 240c0-79.5 64.5-144 144-144l80 0 0-61.3C352 15.5 367.5 0 386.7 0c8.6 0 16.8 3.2 23.2 8.9L548.1 133.3c7.6 6.8 11.9 16.5 11.9 26.7s-4.3 19.9-11.9 26.7l-139 125.1c-5.9 5.3-13.5 8.2-21.4 8.2l-3.7 0c-17.7 0-32-14.3-32-32l0-64zM80 96c-8.8 0-16 7.2-16 16l0 320c0 8.8 7.2 16 16 16l320 0c8.8 0 16-7.2 16-16l0-48c0-17.7 14.3-32 32-32s32 14.3 32 32l0 48c0 44.2-35.8 80-80 80L80 512c-44.2 0-80-35.8-80-80L0 112C0 67.8 35.8 32 80 32l48 0c17.7 0 32 14.3 32 32s-14.3 32-32 32L80 96z" />
                            </svg>
                        </div>
                        <div class=" ml-3">
                        <p class="mt-4 text-[#05264e] font-semibold text-start">Send Invitation</p>
                        <p class="mt-1 text-sm text-[#70756f] text-start">Fill the referral form</p>
                        </div>
                        </div>
                    </div>
                    <div class="w-[100%]">
                        <div class ="flex items-center ">
                        <div class="flex justify-center mt-3 ">
                            <svg class="h-14 w-14 rounded-full pl-1 py-5 bg-white shadow-lg shadow-gray-600" fill="#0070cc" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                                <path d="M96 128a128 128 0 1 1 256 0A128 128 0 1 1 96 128zM0 482.3C0 383.8 79.8 304 178.3 304l91.4 0C368.2 304 448 383.8 448 482.3c0 16.4-13.3 29.7-29.7 29.7L29.7 512C13.3 512 0 498.7 0 482.3zM504 312l0-64-64 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l64 0 0-64c0-13.3 10.7-24 24-24s24 10.7 24 24l0 64 64 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-64 0 0 64c0 13.3-10.7 24-24 24s-24-10.7-24-24z" />
                            </svg>
                        </div>
                        <div class=" ml-3">
                        <p class="mt-4 text-[#05264e] font-semibold text-start">Registration</p>
                        <p class="mt-1 text-sm text-[#70756f] text-start">Let your friends register</p>
                        </div>
                        </div>
                    </div>
                    <div class="w-[100%]">
                        <div class ="flex items-center ">
                        <div class="flex justify-center mt-3 ">
                            <svg class="h-14 w-14 rounded-full py-5 bg-white shadow-lg shadow-gray-600" fill="#0070cc" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                <path d="M184 48l144 0c4.4 0 8 3.6 8 8l0 40L176 96l0-40c0-4.4 3.6-8 8-8zm-56 8l0 40L64 96C28.7 96 0 124.7 0 160l0 96 192 0 128 0 192 0 0-96c0-35.3-28.7-64-64-64l-64 0 0-40c0-30.9-25.1-56-56-56L184 0c-30.9 0-56 25.1-56 56zM512 288l-192 0 0 32c0 17.7-14.3 32-32 32l-64 0c-17.7 0-32-14.3-32-32l0-32L0 288 0 416c0 35.3 28.7 64 64 64l384 0c35.3 0 64-28.7 64-64l0-128z" />
                            </svg>
                        </div>
                        <div class=" ml-3">
                        <p class="mt-4 text-[#05264e] font-semibold text-start">Got Placed</p>
                        <p class="mt-1 text-sm text-[#70756f] text-start">Let your friends get jobs</p>
                        </div>
                        </div>
                    </div>
                    <div class="w-[100%]">
                        ...
                        <div class=" ml-3">
                        <p class="mt-4 text-[#05264e] font-semibold text-start">Get Reward</p>
                        <p class="mt-1 text-sm text-[#70756f] text-start">Claim your reward</p>
                        </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- Shimmer -->
    <div v-if="bottomSection" class="bg-white min-h-20 mb-15 md:mb-10 shadow-lg shadow-gray-600 rounded-lg mx-5 md:mx-10 p-5   overflow-x-hidden">
        ...
        <div class="mt-5">
            ...
            <div v-for="i in 3" :key="i" class="flex w-full mt-3 justify-center text-[#05264e] font-medium">
                <div class="w-[25%] animate-pulse flex gap-4">
                    <img src="https://i.ibb.co/ss8RQ38/user.png" width="50px" class="rounded-full h-[35px] w-[35px] md:h-[50px] md:w-[50px]" />
                    <div class="pt-3 ">
    ...
    <!-- <transition> -->
     <div class="bg-white  min-h-20 mb-15 md:mb-10 shadow-lg shadow-gray-600 rounded-lg mx-5 md:mx-10 p-5">   
    <p class=" text-xl text-[#05264e] font-semibold">Referrals</p>    
    <div v-if="!bottomSection" v-show="index" class=" overflow-x-scroll md:overflow-x-hidden ">
        <!-- <p class=" text-xl text-[#05264e] font-semibold">Referrals</p> -->
        <div class="min-w-[1000px] ">
        ...
        <div class="mt-5">
            ...
            <div v-if="this.candidateDetails.length>0" v-for="candidate in this.candidateDetails" :key="candidate" class="flex w-full mt-3 justify-center text-[#05264e] font-medium">
                <div class="w-[22%] flex gap-4 justify-start">
                    <img v-if="candidate.candidate_image" :src="'https://erp.teamproit.com/'+candidate.candidate_image"  class="rounded-full shadow-lg shadow-gray-400 w-[25px] md:w-[50px]"/>
                    <img v-else src="https://i.ibb.co/ss8RQ38/user.png"  class="rounded-full shadow-lg shadow-gray-400 h-[35px] w-[35px] 
                    md:h-[50px] md:w-[50px]" />
                    <p class="pt-3 text-md md:text-xl ">{{ candidate.given_name }}</p>
                </div>
                <div class="w-[13%] pt-3">{{ candidate.name }}</div>
                <div class="w-[29%] pt-3">{{ candidate.mail_id }}</div>
                <div class="w-[7%] pt-3">{{ candidate.points }}</div>
                ...
                <div v-else-if="candidate.converted_status == 'Proposed PSL'" class="w-[12%] pt-2">
                    <button v-if="claimedCandidates[candidate.name] == 'not ok' && !ifClaimed" @click="claimEvent(userCandidate, candidate.name)" class="w-full flex items-center px-3 gap-2 py-1 border border-[#d97400] rounded-md bg-[#fffbea]">
                    ...
                    <button v-if="claimedCandidates[candidate.name] == 'ok' || ifClaimed" class="w-full cursor-not-allowed opacity-[0.6] flex items-center px-3 gap-2 py-1 border border-[#d97400] rounded-md bg-[#fffbea]">
                        <img src="https://d2rj3iig8nko29.cloudfront.net/staging/media/invite-and-earn-images/rupee.png" width="20px" />
                        <p class="text-md pr-1 font-medium text-[#faa300]">Claimed</p>
                    </button>
                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async claimEvent(supplier, item) {
                ...
                try {
                    ...
                    if (response.data.message === "ok") {
                        this.launchConfetti()
                        this.candidateDetails[item] = "not ok"
                        this.ifClaimed = true;
                    }
                } catch (error) {
            ...
            async isClaimed(userId, candidateId) {
                const response = await apiService.isPurchaseInvoiceCreated(userId, candidateId);
                this.claimedCandidates[candidateId] = response.data.message;
            },
            // async isClaimed(supplier, item) {
            //     try {
            //         const response = await apiService.isPurchaseInvoiceCreated(supplier, item);
            ...
            async checkAllClaims() {
                await this.$nextTick();
                for (const candidate of this.candidateDetails) {
                const claimed = await this.isClaimed(this.userCandidate, candidate.name);
                }
            },
