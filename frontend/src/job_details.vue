<template>
    <div class="border bg-[#efeff5] mt-5 md:mt-0 mb-16 md:mb-0 mx-5 rounded-lg font-sans scroll-smooth pb-5" :class="{'opacity-[0.5] blur-sm': showLoginPopup}">
        <div class="flex md:m-10 md:mx-20 gap-5">
            <div class="w-full md:w-[65%]">
                <div class="bg-white shadow-lg shadow-gray-600 p-5 rounded-lg">
                    <div class="flex justify-between">
                    <div class=" ">
                    <div class="mt-1">
                        <h1 class="text-xl font-semibold md:text-3xl md:font-semibold text-[#05264e]">{{ task.subject }}</h1>
                        <h2 class="text-sm md:text-xl pt-3 font-semibold md:font-semibold text-[#474d6a]">{{ task.customer }}</h2>
                    </div>
                    ...
                    <div class="mt-12">
                         <img v-if="task.custom_customer_logo" :src=" task.custom_customer_logo " :alt="flag-task.name" class="w-[300px] mt-1  " />
                    </div>
                    </div>
                    ...
                    <div class="overflow-auto">
                        ...
                        <div class="flex text-sm text-[#474d6a] mt-1 gap-1 mt-2.5 md:hidden whitespace-nowrap mb-3">
                    ...
                    <hr class="mt-1 md:mt-4">
                    <div class="mt-3 md:mt-5 grid grid-cols-1 md:grid-cols-2">
                        <div class="text-sm text-[#474d6a] mt-1 gap-1 mt-2.5 hidden md:flex">
                            <p class="font-medium text-[#474d6a] pl-1">Posted: <span class="font-semibold">{{ timeAgo(task.creation) }}</span></p>
                            <p>|</p>
                            <p class="font-medium text-[#474d6a] pl-1">Openings: <span class="font-semibold">{{ task.vac }}</span></p>
                            <p>|</p>
                        ...
                        <div class="flex ml-auto gap-3">
                            <button v-if=" !jobApplied " class="flex gap-3 bg-blue-700 hover:bg-blue-800 focus:ring-2 focus:outline-none focus:ring-blue-300 ml-auto text-[white] font-sans md:px-3 md:p-1 text-sm  rounded-md md:rounded-full font-semibold" @click="applyJobs(task.name, task.subject, task.custom_recruiter_contact, id)">
                                <p class="px-2 py-2">Apply Now</p>
                            </button>
                            <button v-if="jobApplied && isloggedIn > 0" class="flex cursor-not-allowed jobs-applied gap-3 ml-auto text-[white] font-sans md:px-3 md:p-1 text-sm rounded-md md:rounded-full font-semibold">
                                <p class="px-2 py-2">Applied</p>
                            </button>
                            <button class="flex gap-3 bg-blue-700 hover:bg-blue-800 focus:ring-2 focus:outline-none focus:ring-blue-300 ml-auto text-[white] font-sans md:px-3 md:p-1 text-sm rounded-md md:rounded-full font-semibold" @click="referJob()">
                ...
                <!-- job benefits -->
                <div class="shadow-lg shadow-gray-600 mt-5 bg-white rounded-lg p-5">
                    <p class="text-2xl font-medium text-xl md:font-semibold md:text-2xl text-[#05264e]">Job Benefits</p>
                    <div class="flex">
                        <div class="flex flex-col gap-4 md:gap-0 md:flex-row md:flex-wrap md:text-center w-full mt-5 md:m-6 overflow-x-auto md:overflow-x-visible overflow-y-visible max-h-[200px] md:max-h-none pb-5 px-1 md:px-0">
                            <!-- Working Hours -->
                            <div class="w-[25%] flex gap-5 md:block">
                                <div class="flex justify-center">
                                    <svg class="h-12 w-12 md:h-16 md:w-16 rounded-full py-3 md:py-5 bg-white shadow-lg shadow-gray-600" xmlns="http://www.w3.org/2000/svg" fill="#0070cc" viewBox="0 0 512 512">
                                        <path d="M256 0a256 256 0 1 1 0 512A256 256 0 1 1 256 0zM232 120l0 136c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2 280 120c0-13.3-10.7-24-24-24s-24 10.7-24 24z" />
                                    </svg>
                                </div>
                                <div class="whitespace-nowrap">
                                    <p class="mt-1 md:mt-4 text-[#05264e] text-[15px] font-semibold">Working Hours</p>
                            ...
                            <div class="w-[25%] flex gap-5 md:block">
                                <div class="flex justify-center">
                                    <svg class="h-12 w-12 md:h-16 md:w-16 rounded-full py-3 md:py-5 bg-white shadow-lg shadow-gray-600" xmlns="http://www.w3.org/2000/svg" fill="#0070cc" viewBox="0 0 448 512">
                                        <path d="M224 0C348.8 0 448 35.2 448 80l0 16 0 320c0 17.7-14.3 32-32 32l0 32c0 17.7-14.3 32-32 32l-32 0c-17.7 0-32-14.3-32-32l0-32-192 0 0 32c0 17.7-14.3 32-32 32l-32 0c-17.7 0-32-14.3-32-32l0-32c-17.7 0-32-14.3-32-32L0 96 0 80C0 35.2 99.2 0 224 0zM64 128l0 128c0 17.7 14.3 32 32 32l256 0c17.7 0 32-14.3 32-32l0-128c0-17.7-14.3-32-32-32L96 96c-17.7 0-32 14.3-32 32zM80 400a32 32 0 1 0 0-64 32 32 0 1 0 0 64zm288 0a32 32 0 1 0 0-64 32 32 0 1 0 0 64z" />
                                    </svg>
                                </div>                
                                <div class="whitespace-nowrap">
                                    <p class="mt-1 md:mt-4 text-[#05264e] text-[15px] font-semibold">Transportation</p>
                            ...
                            <div class="w-[25%] flex gap-5 md:block">
                                <div class="flex justify-center">
                                    <svg class="h-12 w-12 md:h-16 md:w-16 rounded-full py-3 md:py-5 bg-white shadow-lg shadow-gray-600" xmlns="http://www.w3.org/2000/svg" fill="#0070cc" viewBox="0 0 640 512">
                                ...
                                <div class="whitespace-nowrap">
                                    <p class="mt-1 md:mt-4 text-[#05264e] text-[15px] font-semibold">Contract Period</p>
                            ...
                            <div class="w-[25%] flex gap-5 md:block">
                                <div class="flex justify-center">
                                    <svg class="h-12 w-12 md:h-16 md:w-16 rounded-full py-3 md:py-5 bg-white shadow-lg shadow-gray-600" xmlns="http://www.w3.org/2000/svg" fill="#0070cc" viewBox="0 0 576 512">
                                        <path d="M482.3 192c34.2 0 93.7 29 93.7 64c0 36-59.5 64-93.7 64l-116.6 0L265.2 495.9c-5.7 10-16.3 16.1-27.8 16.1l-56.2 0c-10.6 0-18.3-10.2-15.4-20.4l49-171.6L112 320 68.8 377.6c-3 4-7.8 6.4-12.8 6.4l-42 0c-7.8 0-14-6.3-14-14c0-1.3 .2-2.6 .5-3.9L32 256 .5 145.9c-.4-1.3-.5-2.6-.5-3.9c0-7.8 6.3-14 14-14l42 0c5 0 9.8 2.4 12.8 6.4L112 192l102.9 0-49-171.6C162.9 10.2 170.6 0 181.2 0l56.2 0c11.5 0 22.1 6.2 27.8 16.1L365.7 192l116.6 0z" />
                                    </svg>
                                </div>                
                                <div class="whitespace-nowrap">
                                    <p class="mt-1 md:mt-4 text-[#05264e] text-[15px] font-semibold">Flight Ticket</p>
                            ...
                            <div class="w-[25%] flex gap-5 md:block">
                                ...
                                <div class="whitespace-nowrap">
                                    <p class="mt-1 md:mt-4 text-[#05264e] text-[15px] font-semibold">Food</p>
                            ...
                            <div class="w-[25%] flex gap-5 md:block">
                                <div class="flex justify-center">
                                    <svg class="h-12 w-12 md:h-16 md:w-16 rounded-full py-3 md:py-5 bg-white shadow-lg shadow-gray-600" xmlns="http://www.w3.org/2000/svg" fill="#0070cc" viewBox="0 0 384 512">
                                ...
                                <div class="whitespace-nowrap">
                                    <p class="mt-1 md:mt-4 text-[#05264e] text-[15px] font-semibold">Accommodation</p>
                            ...
                            <div class="w-[25%] flex gap-5 md:block">
                                ...
                                <div class="whitespace-nowrap">
                                    <p class="mt-1 md:mt-4 text-[#05264e] text-[15px] font-semibold">Over Time</p>
                            ...
                            <!-- Other Allowance -->
                            <div v-if="task.any_other_allowance" class="w-[25%] flex gap-5 md:block">
                                <div class="flex justify-center">
                                    <svg class="h-12 w-12 md:h-16 md:w-16 rounded-full py-3 md:py-5 bg-white shadow-lg shadow-gray-600" xmlns="http://www.w3.org/2000/svg" fill="#0070cc" viewBox="0 0 448 512">
                                ...
                                <div class="whitespace-nowrap">
                                    <p class="mt-1 md:mt-4 text-[#05264e] text-[15px] font-semibold">Other Allowance</p>
                                    <p class="mt-1 text-sm text-[#70756f] font-medium text-center">{{ task.any_other_allowance }}</p>
                                </div>
                            </div><!--
                             Visa Type -->
                            <div v-if="task.visa_type" class="w-[25%] flex gap-5 md:block">
                                <div class="flex justify-center">
                                    <svg class="h-12 w-12 md:h-16 md:w-16 rounded-full py-3 md:py-5 bg-white shadow-lg shadow-gray-600" xmlns="http://www.w3.org/2000/svg" fill="#0070cc" viewBox="0 0 576 512">
                                ...
                                <div class="whitespace-nowrap">
                                    <p class="mt-1 md:mt-4 text-[#05264e] text-[15px] font-semibold">Visa Type</p>
                ...
                <!-- job highlights and job description -->
                <div class="bg-white shadow-lg shadow-gray-600 rounded-lg mt-5 pb-5 mb-5">
                    &nbsp;
                    <div class="rounded-md shadow p-1 md:p-3 mx-6 bg-[#efeff5]">
                        <div class="m-2 md:m-3">
                            <div class="flex flex-wrap text-[10px] text-[#001d4e] gap-3 font-semibold">
                                <h1 class="font-semibold text-[#000048] text-xl md:font-semibold md:text-2xl">Job Highlights</h1>
                            </div>
                            <ul class="font-medium mt-1.5 text-[13px] md:text-[15px] text-gray-700 pl-2 list-disc pl-6">
                    ...
                    <div>
                        <div class="rounded-md mt-4 md:my-6 mx-7">
                            <div class="text-[13px] text-[#000048] font-semibold">
                                <h1 class="font-semibold text-[#000048] text-xl md:font-semibold md:text-2xl">Job Description</h1>
                                <p class="pt-2 pl-2 text-gray-800 text-[13px] md:text-[15px] font-medium text-left" v-html="task.description"></p>
                ...
                <div class="mt-5 shadow-lg shadow-gray-600 rounded-lg bg-white p-6">
                    <h1 class="text-2xl font-medium text-xl md:font-semibold md:text-2xl text-[#05264e]">About Company</h1>

                    <div class="pl-3">
                        <p class="text-[16px] md:mt-2 md:text-xl pt-0 md:pt-1 font-semibold md:font-semibold text-[#474d6a]">{{ task.customer }}</p>
                        <div class="flex mt-2">
                        ...
                        <div>
                           <p class=" my-2">{{ task.custom_about_customer }}</p>
                        </div>

                        <a :href="task.custom_customer_website" target="_blank" rel="noopener noreferrer">
                            <h2 class="text-md font-sans text-[#001d4e] font-semibold pb-2 ">{{ task.custom_customer_website }}</h2>
                        </a>
                    </div>
                </div>
                <div class="md:hidden">
                    <!-- <hr class="mt-4 border-t border-gray-400"> -->
                    <h1 class="text-2xl mt-4 font-medium text-xl md:font-semibold md:text-2xl text-[#05264e] mb-3">Recent Jobs</h1>
                    <div v-for="task in filteredTasks" :key="task.name">
                        <div class="border rounded-md bg-white shadow-lg shadow-gray-600 transition-colors px-5 relative pt-2 scroll-smooth mb-5">
                            <div class="flex">
                                <h1 class="pt-3 text-md font-sans text-gray-900 font-bold capitalize" style="color: #05264e;">{{ task.subject }}</h1>
                            </div>
                            <div class="flex mt-2">
                                <img v-if="task.custom_country_flag" :src="task.custom_country_flag" :alt="flag-task.name" class="image-size mr-2" />
                                <h2 class="text-sm font-sans text-[#001d4e] font-semibold uppercase">{{ task.territory }}</h2>
                            </div>
                            ...
                            <div class="flex flex-wrap mb-4" :class="iClick ? 'mt-0' : 'mt-6'">
                                ...
                                <button v-if="appliedJobs[task.name] && isloggedIn > 0" class="text-white jobs-applied cursor-not-allowed hover:bg-blue-400 focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-[12px] px-2 py-1 text-center ml-2">
                                    <p>Applied</p>
                                </button>
                            </div>
                        </div>
            ...
            <div class="md:w-[35%] hidden md:block">
                <div v-for="task in filteredTasks" :key="task.name">
                    <div class="border rounded-md bg-white shadow-lg shadow-gray-600 transition-colors px-5 relative pt-2 scroll-smooth mb-5">
    ...
    <Transition name="fade-scale">
        <div v-if="showLoginPopuprf" class="fixed inset-0 flex justify-center items-center z-30">
            <div class="bg-white p-6 rounded-md border-0 shadow-lg shadow-gray-600 w-[300px]">
                <button @click="showLoginPopuprf=false" class="close-button h-5 w-5 ml-[90%]">
                    <img src="https://i.postimg.cc/dVQFYNh9/close.png" alt="close" class="mt-[-10px]" />
                </button>
     ...
     <Transition name="fade-scale">
        <div v-if="showReferFriendPopup" class="fixed inset-0 flex justify-center items-center z-30">
            <div class="bg-white p-6 rounded-md border-0 shadow-lg shadow-gray-600 w-[300px]">
                <button @click="showReferFriendPopup=false" class="close-button h-5 w-5 ml-[90%]">
                    <img src="https://i.postimg.cc/dVQFYNh9/close.png" alt="close" class="mt-[-10px]" />
                </button>
                <form>
                <label for="friend_name" class="text-md font-semibold mr-1 " style="color: #05264e;">Friend Name</label><span class="text-red-500">*</span><br>    
                <input type="text" id="friend_name" name="friend_name" v-model="friend_name"  class="rounded-md mt-2 w-full" placeholder="Friend Name" required/>
                <button class="bg-blue-700 hover:bg-blue-800 focus:ring-2 focus:outline-none focus:ring-blue-300 text-[white] font-sans px-3 p-1 text-sm rounded-md w-full mt-3 font-semibold" @click="referJobpopup()">
                    <p class="px-2 py-2 text-center">Submit</p>
                </button>
                </form>
            </div>
    ...
    export default {
        data() {
            return {
                ...
                task: {
                    ...
                    custom_customer_website:null,
                    custom_customer_logo:null,
                    custom_about_customer:null,
                    project:null,
        ...
        methods: {
            ...
            async checkIfApplied(task, id) {
                if (this.isloggedIn > 0) {
                    ...
                    if (response && response.data.message === "true") {
                       this.appliedJobs[task.name] = true;
                    } else {
                       this.appliedJobs[task.name] = false;
                    }
                } else {
                   this.appliedJobs[task.name] =false;
                }
            ...
            async fetchTaskDetails() {
                ...
                this.custom_customer_website = this.task.custom_customer_website || null;
                this.custom_about_customer = this.task.custom_about_customer || null;
                this.project = this.task.project || null;
                ...
                if(this.project){
                    this.fetchTaskCustomerPhoto();
                }
            },

            async fetchTaskCustomerPhoto(){

                
                this.projectDetails = await apiService.getProjectDetails(this.project);
                this.custom_customer_logo = this.projectDetails.custom_customer_logo || null;
          ...
          async  referJob() {
                ...
                this.showReferFriendPopup =true; 

            try{
                const taskName = this.$route.params.taskName;
                this.task = await apiService.getTaskDetails(taskName);
                this.subject = this.task.subject || null;
                this.territory = this.task.territory || null;
            } catch (error) {
        console.error("Error fetching task details:", error);
    }
                
} else {
                    this.showLoginPopuprf = true;
                }
...
https://erp.teamproit.com/jobpro_web`
